...
public class Doctor_SchedAppointment extends JPanel implements ActionListener{
    ...
    public Doctor_SchedAppointment() {
        ...
        lblPatients = new JLabel("15 Today's Patients", SwingConstants.CENTER);
        ...
        lblAvail = new JLabel("4 Review Prescriptions", SwingConstants.CENTER);
        ...
        lblUrgent = new JLabel("4 Urgent Cases", SwingConstants.CENTER);
        ...
        lblApp = new JLabel("9 Pending Appointments", SwingConstants.CENTER);
        ...
        lblStatus = new JLabel("Status: Complete");
        ...
        btnNote = new JButton("Update Notes");
        ...
        lblTDAp = new JLabel("Appointments for April 15, 2026");
