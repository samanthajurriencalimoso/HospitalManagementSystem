...
public class Doctor_SchedAppointment extends JPanel implements ActionListener{
    ...
    public Doctor_SchedAppointment() {
        ...
        JLabel lblAvail = new JLabel("4 Review Prescriptions", SwingConstants.CENTER);
        ...
        JLabel lblUrgent = new JLabel("4 Urgent Cases", SwingConstants.CENTER);
        ...
        JLabel lblApp = new JLabel("9 Pending Appointments", SwingConstants.CENTER);
        ...
        JLabel lblStatus = new JLabel("Status: Complete");
        ...
        JButton btnNote = new JButton("Update Notes");
        ...
        JLabel lblTDAp = new JLabel("Appointments for April 15, 2026");
        ...
        String[][] rwAppointments = {{"10:30 AM", "P-10025", "Elena Cruz", "Check-up", "Scheduled"}, 
                                     {"12:30 PM", "P-10026", "Grace Delos Santos", "Check-up", "Scheduled"},
                                     {"01:30 PM", "P-10027", "Macayle Santos", "Surgery", "Scheduled"}};
        ...
        JButton btnView = new JButton("View All Appointments");
